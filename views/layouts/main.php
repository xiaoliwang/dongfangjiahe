...
<meta name="keywords" content="东方佳合,东方佳合基金,北京东方佳合,北京东方佳合基金管理有限公司,基金,金融,投资管理,PE,民营">
    <?= Html::csrfMetaTags()?>
...
echo Nav::widget([
    ...
    'items' => [
        ...
        ['label' => '关于我们', 'dropDownOptions' => ['class' => 'ul-transparent'],
    		...
    		['label' => '投资团队', 'url' => ['/site/people']],
        	['label' => '业务领域', 'url' => ['/site/about', 'type' => 2]],
        	['label' => '投资策略', 'url' => ['/site/about', 'type' => 3]],
        ]],
    	['label' => '行业新闻', 'dropDownOptions' => ['class' => 'ul-transparent'],
    		'activateParents' => true, 'items' => [
    		['label' => '军民融合', 'url' => ['/site/news', 'type' => 5]],
		['label' => '能源产业', 'url' => ['/site/news', 'type' => 6]],
                ['label' => '文化旅游', 'url' => ['/site/news', 'type' => 7]],
                ['label' => '投资知识', 'url' => ['/site/news', 'type' => 8]],
        ]],
	['label' => '公司动态', 'dropDownOptions' => ['class' => 'ul-transparent'],
		...
		'items' => [
			...
			['label' => '公司公告', 'url' => ['/site/news', 'type' => 3]],
        ]],
